    ...
    public void initialise() {
        ...
        addSettings(new ButtonSetting("Choose Image", "Display", "Picks your desired image to be rendered.", () -> {
            ...
            new Thread(() -> {
                ...
                EssentialAPI.getNotifications().push("EvergreenHUD", "The file dialogue has just been opened. You may need to tab out to see it.");
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    changed = true;
                    EssentialAPI.getNotifications().push("EvergreenHUD", "You have selected a new image.");
                } else {
                    EssentialAPI.getNotifications().push("EvergreenHUD", "You must select an image.");
                }
            }).start();
        }));
