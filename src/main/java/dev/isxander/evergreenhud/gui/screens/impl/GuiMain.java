...
public class GuiMain extends GuiScreenElements {
    ...
    public void initGui() {
        ...
        if (!EvergreenHUD.getInstance().getElementManager().isEnabled())
            EssentialAPI.getNotifications().push("EvergreenHUD", "The mod is disabled. You will not see the hud in-game unless you enable it.");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(mc.fontRendererObj, EvergreenHUD.MOD_VERSION + "-rev." + EvergreenHUD.MOD_REVISION, width / 2, 25, -1);
