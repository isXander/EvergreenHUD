...
import dev.isxander.evergreenhud.config.convert.impl.EvergreenHudConverter
...
interface ConfigConverter {
    ...
    companion object {
        val all = listOf<ConfigConverter>(ChromaHudConverter, KronHudConverter, EvergreenHudConverter.V14, EvergreenHudConverter.V13)
    }
}
