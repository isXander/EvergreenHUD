...
class ColorSettingWrapped(annotation: ColorSetting, annotatedObject: Any, annotatedProperty: KProperty1<out Any, Color>) : Setting<Color, ColorSetting>(annotation, annotatedObject, annotatedProperty, JsonType.INT) {
