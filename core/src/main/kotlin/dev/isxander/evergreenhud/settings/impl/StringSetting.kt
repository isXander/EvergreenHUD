...
@MustBeDocumented
annotation class StringSetting(val name: String, val category: String, val subcategory: String = "", val description: String, val save: Boolean = true)

class StringSettingWrapped(annotation: StringSetting, provider: IValueProvider<String>) : Setting<String, StringSetting>(annotation, provider, DataType.STRING) {
